...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      <NavLink to="/officerdashboard"  onClick={() => setActiveLink('dashboard')}>
        <span className="material-icons-sharp">dashboard</span>
        <h3>Dashboard</h3>
      </NavLink>
      <NavLink to="/officerpayment"  onClick={() => setActiveLink('dashboard')}>
        <span className="material-icons-sharp">request_quote</span>
        <h3>Payment</h3>
      </NavLink>
